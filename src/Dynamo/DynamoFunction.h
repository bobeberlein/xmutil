...
FSubclass(DFunctionAbs, "ABS", 1, "ABS") FSubclass(DFunctionExp, "EXP", 1, "EXP")
    FSubclass(DFunctionSqrt, "SQRT", 1, "SQRT")

        FSubclass(DFunctionCosine, "COS", 1, "COS") FSubclass(DFunctionTangent, "TAN", 1, "TAN")
            FSubclass(DFunctionSine, "SIN", 1, "SIN") FSubclass(DFunctionArcCosine, "ARCCOS", 1, "ARCCOS")
                FSubclass(DFunctionArcSine, "ARCSIN", 1, "ARCSIN") FSubclass(DFunctionArcTangent, "ARCTAN", 1, "ARCTAN")
                    FSubclass(DFunctionInterger, "INTEGER", 1, "INT")

                        FSubclass(DFunctionMax, "MAX", 2, "MAX") FSubclass(DFunctionMin, "MIN", 2, "MIN")
...
DFSubclass(DFunctionSmooth, "SMOOTH", 2, "SMTH1") DFSubclass(DFunctionSmoothI, "SMOOTHI", 3, "SMTH1")
    DFSubclass(DFunctionSmooth3, "SMOOTH3", 2, "SMTH3") DFSubclass(DFunctionSmooth3I, "SMOOTH3I", 3, "SMTH3")
        DFSubclass(DFunctionTrend, "TREND", 3, "TREND") DFSubclass(DFunctionFrcst, "FORECAST", 3, "FORCST")
            DFSubclass(DFunctionDelay1, "DELAY1", 2, "DELAY1") DFSubclass(DFunctionDelay1I, "DELAY1I", 3, "DELAY1")
                DFSubclass(DFunctionDelay3, "DELAY3", 2, "DELAY3") DFSubclass(DFunctionDelay3I, "DELAY3I", 3, "DELAY3")
                    DFSubclass(DFunctionDelay, "DELAY FIXED", 3, "DELAY") DFSubclass(DFunctionNPV, "NPV", 4, "NPV")
...
;
FSubclass(DFunctionInitial, "INITIAL", 1, "INIT") FSubclass(DFunctionReInitial, "REINITIAL", 1, "INIT")

    FSubclassTime(DFunctionRamp, "RAMP", 3, "RAMP") FSubclass(DFunctionLn, "LN", 1, "LN")
