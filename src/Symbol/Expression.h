...
{
public :
   ExpressionFunctionMemory(SymbolNameSpace *sns,Function *f,ExpressionList *args) : ExpressionFunction(sns,f,args) {pPlacholderEquation = NULL ;}
...
{
public:
	FlowList()  { bValid = true; pActiveExpression = NULL;  pNewVariable = NULL; }
