...
public :
   ...
   virtual void AddEq(Equation* eq, bool init) { assert(false); }
   virtual Equation *GetEquation(int pos) { return NULL ; }
   virtual std::vector<Equation*> GetAllEquations() { return std::vector<Equation*>(); }
   virtual std::vector<Equation*> GetAllInitEquations() { return std::vector<Equation*>(); }
   ...
   virtual std::vector<Variable*> GetInitInputVars() { return std::vector<Variable*>(); }
   ...
   virtual int SubscriptCount(std::vector<Variable *> &elmlist) { return 0; }
...
{
public :
   VariableContentVar(void)  { pUnits = NULL ; }
   ...
   void Clear(void) ;
   void AddEq(Equation* eq, bool init) { if (init) vInitEquations.push_back(eq); else  vEquations.push_back(eq); }
   virtual Equation *GetEquation(int pos) { return vEquations[pos] ; }
   virtual std::vector<Equation*> GetAllEquations() { return vEquations; }
   virtual std::vector<Equation*> GetAllInitEquations() { return vInitEquations; }
...
public:
   ...
   ModelGroup* GetGroup() const { return _group; }
   void SetGroup(ModelGroup* set) { _group = set; }

   void SetComment(const std::string& com) { _comment = com; }
   void SetUnitsString(const std::string& set) { _units = set; }
   const std::string& GetUnitsString() const { return _units; }
   ...
   std::vector<Equation*> GetAllInitEquations() { return pVariableContent ? pVariableContent->GetAllInitEquations() : std::vector<Equation*>(); }
   ...
   inline std::vector<Variable*>GetInitInputVars() { return pVariableContent ? pVariableContent->GetInitInputVars() : std::vector<Variable*>(); }
