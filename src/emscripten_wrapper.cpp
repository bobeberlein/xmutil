...
std::string convertMdlToXmile(const std::string &mdlContent, bool isCompact = false, int isLongName = 0,
                              bool isAsSectors = false) {
...
EMSCRIPTEN_BINDINGS(xmutil_module) {
  emscripten::function("convertMdlToXmile", emscripten::optional_override([](const std::string &mdlContent) {
